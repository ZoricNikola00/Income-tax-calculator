	...
	return (
		<div className="mt-[50px] h-fit flex justify-center items-center flex-col">
			<div className="customShadow text-primary mb-10 w-[90%] md:-[500px] lg:w-[600px] flex items-center justify-center p-4 bg-white rounded-lg">
				...
				<h1 className="ml-3 font-bold text-xl md:text-2xl">
			...
			<div className="w-[90%] md:-[500px] lg:w-[600px] flex-col h-auto bg-white rounded-lg customShadow">
				<div className="flex w-full text-primary">
					<div
						...
						} cursor-pointer hover:bg-primary hover:text-white transition-all text-lg font-bold duration-500 w-full p-4 text-center border-b-[5px]  border-secondary rounded-tl-lg border-r`}
					>
						Form Income
					</div>
					<div
						...
						className={`${
							...
							formData.income && formData.type
								? 'cursor-pointer'
								: 'cursor-not-allowed'
						} hover:bg-primary hover:text-white transition-all text-lg font-bold duration-500 w-full p-4 text-center border-b-[5px]  border-secondary rounded-tr-lg border-l`}
					>
						Income Details
					</div>
				</div>
